package rodrigues.ferreira.ricardo.auth.user.domain.service;
...
import rodrigues.ferreira.ricardo.auth.user.domain.PasswordTokenPublicData;
import rodrigues.ferreira.ricardo.auth.user.domain.exception.UserEntityNotFoundException;
